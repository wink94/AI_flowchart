"""
Mask R-CNN
Train on the toy flowchart dataset and implement color splash effect.
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i, p in enumerate(info["polygons"]):
            ...
            #for rectangle annotated dataset
            # all_points_x=[]
            # all_points_y=[]
            # all_points_x.append(p["x"])
            # all_points_x.append(p["x"]+p["width"])
            # all_points_y.append(p["y"])
            # all_points_y.append(p["x"]+p["height"])
            if p['name'] == 'rect':
...
def train(model):
    ...
    dataset_train.load_flowchart(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = FlowchartDataset()
    dataset_val.load_flowchart(args.dataset, "val")
    dataset_val.prepare()
